...
static void load_gl_extensions(void) {
  ...
  glDeleteProgram =
      (PFNGLDELETEPROGRAMPROC)glfwGetProcAddress("glDeleteProgram");
  ...
  glFramebufferTexture2D = (PFNGLFRAMEBUFFERTEXTURE2DPROC)glfwGetProcAddress(
      "glFramebufferTexture2D");
  glCheckFramebufferStatus =
      (PFNGLCHECKFRAMEBUFFERSTATUSPROC)glfwGetProcAddress(
          "glCheckFramebufferStatus");
  ...
  glDrawArraysEXT =
      (PFNGLDRAWARRAYSEXTPROC)glfwGetProcAddress("glDrawArraysEXT");
#ifdef _WIN32
  glActiveTexture =
      (PFNGLACTIVETEXTUREPROC)glfwGetProcAddress("glActiveTexture");
#endif // _WIN32
  ...
  if (glfwExtensionSupported("GL_ARB_debug_output")) {
    ...
    glDebugMessageCallback = (PFNGLDEBUGMESSAGECALLBACKPROC)glfwGetProcAddress(
  ...
  if (glfwExtensionSupported("GL_EXT_draw_instanced")) {
    ...
    glDrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDPROC)glfwGetProcAddress(
